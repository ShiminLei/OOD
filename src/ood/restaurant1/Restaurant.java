...
public class Restaurant {
    ...
    public String restaurantDescription()
    {
        ...
        for(int i = 0; i < tables.size(); i++)
        {
            ...
            description += ("ood.restaurant.Table: " + i + ", table size: " + table.getCapacity() + ", isAvailable: " + table.isAvailable() + ".");
            if(table.getCurrentOrder() == null)
                description += " No current order for this table";
            else
                description +=  " ood.restaurant.Order price: " + table.getCurrentOrder().getBill();
